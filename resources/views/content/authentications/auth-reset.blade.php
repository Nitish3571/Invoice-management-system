                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="#" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-semibold">{{ 'CodeRunner' }}</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                                    ...
                                    <div class="input-group input-group-merge">
                                        <div class="form-floating form-floating-outline">
                                            <input type="text"
                                                ...
                                                name="password" placeholder="Enter new password" autofocus>
                                            <label>New Password</label>
                                            @error('password')
                                    ...
                                    <div class="input-group input-group-merge">
                                        <div class="form-floating form-floating-outline">
                                            <input type="text"
                                                ...
                                                name="cpassword" placeholder="Enter new password" autofocus>
